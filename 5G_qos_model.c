...
static void init_threads_data(void(*verdict)(uint32_t, uint32_t, uint32_t))
{
  ...
  mac_data.dyn_chan_data = read_channel_data("/home/mikel/Mahaigaina/NFQUEUE_Eurecomm/scripts/packets_pedestrian.txt");
//mac_data.dyn_chan_data = read_channel_data("/home/mikel/Mahaigaina/NFQUEUE_Eurecomm/scripts/packets_train.txt");
#endif 
}
